...
@Service("empdao")
public class EmployeeV2DAOImpl implements EmployeeV2DAO{

    public String insertEmp(EmployeeVO2 emp2) {
    ...
    public ArrayList<EmployeeVO2> selectEmp() {
    ...
    public EmployeeVO2 selectOneEmp(String empno) {
    ...
    public String updateEmp(EmployeeVO2 evo2) {
        Connection conn = null;
        PreparedStatement pstmt = null;
    ...
    public String removeEmp(int empno) {
        Connection conn = null;
        PreparedStatement pstmt = null;
